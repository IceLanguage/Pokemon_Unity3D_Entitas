namespace TinyTeam.UI
{
    ...
    public abstract class TTUIPage
    {
        ...
        public static List<TTUIPage> currentPageNodes { get; private set; }
        ...
        private static void PopNode(TTUIPage page)
        {
            ...
            {
                currentPageNodes = new List<TTUIPage>();
            }
        ...
        private static void HideOldNodes()
        {
            ...
            TTUIPage topPage = currentPageNodes[currentPageNodes.Count - 1];
        ...
        private static void ShowPage<T>(Action callback = null, object pageData=null, bool isAsync=false) where T : TTUIPage, new()
        {
            Type t = typeof(T);
        ...
        public static void ClosePage()
        {
            ...
            TTUIPage closePage = currentPageNodes[currentPageNodes.Count - 1];
            ...
            {
                TTUIPage page = currentPageNodes[currentPageNodes.Count - 1];
                if (page.isAsyncUI)
        ...
        public static void ClosePage(TTUIPage target)
        {
            ...
            if (currentPageNodes != null && currentPageNodes.Count >= 1 && currentPageNodes[currentPageNodes.Count - 1] == target)
            {
                currentPageNodes.RemoveAt(currentPageNodes.Count - 1);
        ...
        #endregion
        protected void ShowUI(GameObject go)
        {
            if (!go.activeSelf)
                go.SetActive(true);
        }

        protected void HideUI(GameObject go)
        {
            if (go.activeSelf)
                go.SetActive(false);
        }
