...
public class UIBattle_Pokemons : TTUIPage
{
    ...
    private List<Text> EnergyPowerText_list = new List<Text>();
    private List<Text> EnergyDefenceText_list = new List<Text>();
    private List<Text> SpeedText_list = new List<Text>();
    private List<Text> RaceNameText_list = new List<Text>();
    private List<Text> PokemonTypeText_list = new List<Text>();
    private List<Text> NatureText_list = new List<Text>();
    private List<Text> AbilityText_list = new List<Text>();
